...
def menu():
    ...
    print (' (%s05%s) %sDump Id Facebook Nama'%(P,H))
    print (' (%s06%s) %sDump Id Facebook Group'%(O,P))
    print (' (%s07%s) %sDump Id Facebook Pesan Mesengger'%(O,P))
    print (' (%s08%s) %sMemulai Crack/Start crack %s'%(O,P,)) 
